 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme North
...
add_action( 'tgmpa_register', 'north_register_required_plugins' );
 ...
 */
function north_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'north_wpforms_shareasale_id' );

function north_wpforms_shareasale_id( $shareasale_id ) {
